...
$(function () {
            ...
            $("#search-results>.sr-items")
              ...
              .append(
                curHits.map(function (hit) {
                  ...
                  var searchResultKeywords = itemBrief.replace(/<!--(.*?)-->/gm, "");
  ...
  function renderSidebar() {
    ...
    function registerTocEvents() {
      ...
      var tocModuleSelector = $("#toc_module_selector");

      tocModuleSelector.on("change", function (e) {
        sessionStorage.selectedModule = this.value;
        window.location = this.value;
      });

      selectElement("toc_module_selector", sessionStorage.selectedModule);
  ...
  function renderAffix() {
    ...
    if (hierarchy && hierarchy.length > 0) {
      var html = '<h5 class="title">In this topic</h5>';
